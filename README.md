...
| SDK     | README                                         |
| ------- | ---------------------------------------------- |
| Angular | [lib/angular/README.md](lib/angular/README.md) |
...
Configuration is done through a singleton instance located in [config.ts](src/config.ts):
...
```typescript
type BuiltInNodeProp = "label" | "labelColor" | "labelFontSize" | "description" | "descriptionColor" | "backgroundColor" | "borderColor" | "imageUrl" | "imageWidth" | "imageHeight";
```
